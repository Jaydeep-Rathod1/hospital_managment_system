        ...
        children: [
          Obx(() =>
              ListView.builder(
                ...
                itemCount: controller.doctorByDepartmentList.length,
                itemBuilder: (context,int index){
                  /*return Text("index = ${index}");*/
                  if(controller.doctorByDepartmentList.length>0){
                    return InkWell(
                      onTap: (){
                        Get.toNamed(Routes.DOCTORDETAILS,arguments: {"userData" : controller.doctorByDepartmentList[index]});
                      },
                      child: Card(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        ...
                                        child: Column(
                                          ...
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          children: [
                                            CustomText(text: 'Dr. ${controller.doctorByDepartmentList[index].firstname} ${controller.doctorByDepartmentList[index].lastname}',fontSize: 16,maxLines: 1,textOverflow: TextOverflow.ellipsis),
                                            SizedBox(height: 5,),
                                            CustomText(text: '${controller.doctorByDepartmentList[index].education}',fontSize: 12,maxLines: 1,textOverflow: TextOverflow.ellipsis,color: ColorManager.darkGrey,fontWeight: FontWeight.normal,),
                                            Row(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              ...
                                              children: [
                                                ...
                                                CustomText(text: '${controller.doctorByDepartmentList[index].experience ?? 0} years',fontSize: 12,maxLines: 2,textOverflow: TextOverflow.ellipsis,fontWeight: FontWeight.w500),
                                              ],
                                            ),
                                            Row(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    return const Center(child: CustomText(text: "Doctor Data Not Found",fontSize: 20,));
                  }

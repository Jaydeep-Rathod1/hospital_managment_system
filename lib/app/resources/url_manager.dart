...
class UrlManager{
  static String MAIN_URL = "http://192.168.0.109/hms/";
  ...
  static String EDIT_PROFILE_URL = "${BASE_URL}edit_profile.php";
  static String ADD_APPOITNMENT = "${BASE_URL}add_appointment.php";
  ...
  static String GET_APPOITNMENT_DOCTOR = "${BASE_URL}get_all_booked_slot.php";
